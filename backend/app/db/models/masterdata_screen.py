# This file defines the "MasterData_screens" table: the registry of every
# screen that exists inside the MasterData module (e.g. "Season", "Roles").
#
# This table is never edited by hand — it's kept in sync automatically
# every time the backend starts (see app/modules/module_9/screens.py),
...
class MasterDataScreen(Base):
    """One row per screen that exists inside the MasterData module."""

    __tablename__ = "MasterData_screens"

    id: Mapped[int] = mapped_column(primary_key=True)

    # A stable, code-friendly identifier, e.g. "masterdata.roles". This is
