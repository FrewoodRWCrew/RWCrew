# This file defines the "InterventionRequests_screens" table: the
# registry of every screen that exists inside the Intervention Requests
# module (e.g. "Intervention Requests", "Roles").
#
# This table is never edited by hand — it's kept in sync automatically
# every time the backend starts (see app/modules/module_3/screens.py),
...
class InterventionRequestsScreen(Base):
    """One row per screen that exists inside the Intervention Requests module."""

    __tablename__ = "InterventionRequests_screens"

    id: Mapped[int] = mapped_column(primary_key=True)

    # A stable, code-friendly identifier, e.g. "interventionrequests.roles".
