// This layout wraps every KarTracker page (the landing card and everything
...
export default async function KarTrackerLayout({ children }: KarTrackerLayoutProps) {
  let permissions: KarTrackerMyPermissions | null = null;
  let forbidden = false;

  try {
    permissions = await serverApiFetch<KarTrackerMyPermissions>("/api/modules/module-2/me/permissions");
  } catch (error) {
