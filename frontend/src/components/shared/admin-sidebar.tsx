...
// tagscan-sidebar.tsx / kartracker-sidebar.tsx / intervention-requests-
// sidebar.tsx / masterdata-sidebar.tsx) — showing this site-wide menu
// alongside one of them would just be a redundant second sidebar. The
// Topbar's logo link already covers "back to the landing page" while this
// is hidden.
const MODULES_WITH_OWN_SIDEBAR = ["/modules/module-1", "/modules/module-2", "/modules/module-3", "/modules/module-9"];
